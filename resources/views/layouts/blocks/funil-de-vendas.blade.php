...
<main id="main">
        ...
        <section class="recurso-block" aria-labelledby="funil-obrigatorias-title">
            <div class="container recurso-split">
                ...
                <div class="recurso-split__visual">
                    <div class="shot">
                        <img src="{{asset('storage/site/recurso-followup.png')}}" alt="Tela do Digify com informações e atividades registradas em uma oportunidade" width="1672" height="940" loading="lazy">
                    </div>
                </div>
            </div>
        </section>
